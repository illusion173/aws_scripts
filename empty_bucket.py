...
def empty_bucket(bucket_num_delete):
    ...
    print("Cleaned Bucket!")
    print("")
    print("")

while 1:
    bucket_num_delete = int(input("Which bucket do you want to empty (Enter integer): "))
    
    empty_bucket(bucket_num_delete)
